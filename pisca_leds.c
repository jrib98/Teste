 ...
 * Author: joao.ribeiro
 *
 * Created on 16 de Setembro de 2021, 11:17
 */
...
void main(void) {
     TRISBbits.TRISB7 = 0; //Configura RB7 como saida
     TRISAbits.TRISA3 = 0; //Configura RA3 como saida
     ANSELA = 0b00000000;  // habilita PORTA como I/O
     LED1 = 0; 
     LED2 = 0; 
     while(1){
         LED1 = 1;
